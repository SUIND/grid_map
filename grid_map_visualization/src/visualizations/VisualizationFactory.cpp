...
{
VisualizationFactory::VisualizationFactory(ros::NodeHandle& nodeHandle) : nodeHandle_(nodeHandle)
{
...
std::shared_ptr<VisualizationBase> VisualizationFactory::getInstance(const std::string& type, const std::string& name)
{
