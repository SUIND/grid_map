...
class TestCostmap2DConversion : public testing::Test
{
 public:
  ...
  //! Constructor
  TestCostmap2DConversion() : costmap2d_(8, 5, 1.0, 2.0, 3.0)
  {
    gridMap_.setGeometry(Length(8.0, 5.0), 1.0, Position(6.0, 5.5));
  }
...
TestCostmap2DConversion<Costmap2DDirectTranslationTable>::getTestValues()
{
  ...
  testValues.emplace_back(TestValue(Position(4.2, 4.1), costmap_2d::INSCRIBED_INFLATED_OBSTACLE,
                                    costmap_2d::INSCRIBED_INFLATED_OBSTACLE, true));
  testValues.emplace_back(
      TestValue(Position(6.2, 3.1), costmap_2d::LETHAL_OBSTACLE, costmap_2d::LETHAL_OBSTACLE, true));
...
using TranslationTableTestTypes =
    ::testing::Types<Costmap2DSpecialTranslationTable, Costmap2DLargeIntervalsTranslationTable,
