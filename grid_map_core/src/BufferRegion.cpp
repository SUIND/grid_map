...
BufferRegion::BufferRegion()
    : staretIndex_(Index::Zero()), size_(Size::Zero()), quadrant_(BufferRegion::Quadrant::Undefined)
{
}

BufferRegion::BufferRegion(const Index& index, const Size& size, const BufferRegion::Quadrant& quadrant)
    : staretIndex_(index), size_(size), quadrant_(quadrant)
{
}

BufferRegion::~BufferRegion() {}

const Index& BufferRegion::getStartIndex() const { return staretIndex_; }

void BufferRegion::setStartIndex(const Index& staretIndex) { staretIndex_ = staretIndex; }
