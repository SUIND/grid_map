...
const Index& ThickenedLineIterator::operator*() const { return *(*polygonIterator_); }
...
bool ThickenedLineIterator::isPastEnd() const { return polygonIterator_->isPastEnd(); }

bool ThickenedLineIterator::initialize(const grid_map::GridMap& gridMap, const Position& start, const Position& end,
