...
Polygon::Polygon(std::vector<Position, Eigen::aligned_allocator<Position>> vertices) : Polygon()
{
  vertices_ = vertices;
}
...
const std::vector<Position, Eigen::aligned_allocator<Position>>& Polygon::getVertices() const { return vertices_; }
