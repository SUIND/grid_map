...
{
GridMapToImageDemo::GridMapToImageDemo(ros::NodeHandle& nodeHandle) : nodeHandle_(nodeHandle)
{
  readParameters();
...
{
  ROS_INFO("Saving map received from: %s to file %s.", nodeHandle_.resolveName(gridMapTopic_).c_str(),
           filePath_.c_str());
